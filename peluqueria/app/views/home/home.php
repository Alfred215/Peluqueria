...
<body>
  <br>
  <header>
  <a class="nav" href="<?php echo PATH."/employer/trabajador" ?>">TRABAJADORES</a>  
  <h1>Aqua By Rocio</h1>
  <a class="nav" href="<?php echo PATH."/login/index" ?>">LOGIN</a>
  </header>
  <img style="margin-top: 30px;" src="<?php echo $home->urls;?>" alt="imagen">
  ...
  <section>
    ...
    <article>
      ...
      <div class="servicio">
        <img class="servicios" src="fotos/color.jpg" alt="imagen">
        <h3>COLOR</h3>
        <hr>
